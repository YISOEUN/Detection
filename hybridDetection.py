...
# anomaly detection
anomaly_file = 'C:/Users/samsung/Desktop/Dataset_Anomaly_AttributeSelection.csv'
...
# Read test data
test_file = 'C:/Users/samsung/Desktop/testData.csv'
...
rocvis(test_y, result_lr,"Logistic Regression")
rocvis(test_y, result_dt,"Decision Tree")
rocvis(test_y, result_rf,"Random Forest")
rocvis(test_y, result_gb,"Gradient Boosting")
...
index = 0
result_gb = list(randomForest_best.predict(normal_X))
# Confusion Matrix
